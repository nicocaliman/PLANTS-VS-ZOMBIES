...
public class PlantsVsZombies 
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println(Messages.WELCOME);														//"PlantsVsZombies 1.0"

		Game game = new Game(seed, level);															//create game object
		
		Scanner scanner = new Scanner(System.in);													//create scanner object
		
		Controller controller = new Controller(game, scanner);										//create controller object													
		
		controller.run();																			//call run() from Controller class
	}
